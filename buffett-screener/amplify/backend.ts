...
const weeklyRunsTable = backend.data.resources.cfnResources.amplifyDynamoDbTables['WeeklyRun'];
const stockScoresTable = backend.data.resources.cfnResources.amplifyDynamoDbTables['StockScore'];
const rollingScoresTable = backend.data.resources.cfnResources.amplifyDynamoDbTables['RollingScore'];
...
// EventBridge Scheduler (Weekly on Friday at 5 PM UTC)
const weeklyRule = new events.Rule(stack, 'WeeklyRunRule', {
